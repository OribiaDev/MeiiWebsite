...
const Commands = () => {
    ...
    const [commands] = useState([
        ...
        {commandName: '/kiss', commandDesc:"Sends a gif emote of you kissing the mentioned person", commandUsage:"/kiss [@person]", filter:"emotes", id: 12},
        {commandName: '/hug', commandDesc:"Sends a gif emote of you hugging the mentioned person", commandUsage:"/hug [@person]", filter:"emotes", id: 13},
        {commandName: '/cuddle', commandDesc:"Sends a gif emote of you cuddling the mentioned person", commandUsage:"/cuddle [@person]", filter:"emotes", id: 14},
        {commandName: '/slap', commandDesc:"Sends a gif emote of you slapping the mentioned person", commandUsage:"/slap [@person]", filter:"emotes", id: 15},
        {commandName: '/kill', commandDesc:"Sends a gif emote of you killing the mentioned person", commandUsage:"/kill [@person]", filter:"emotes", id: 16},
        {commandName: '/yeet', commandDesc:"Sends a gif emote of you yeeting the mentioned person", commandUsage:"/yeet [@person]", filter:"emotes", id: 17},
        {commandName: '/bonk', commandDesc:"Sends a gif emote of you bonking the mentioned person", commandUsage:"/bonk [@person]", filter:"emotes", id: 18},
        {commandName: '/poke', commandDesc:"Sends a gif emote of you poking the mentioned person", commandUsage:"/poke [@person]", filter:"emotes", id: 19},
        {commandName: '/handhold', commandDesc:"Sends a gif emote of you holding hands with the mentioned person", commandUsage:"/handhold [@person]", filter:"emotes", id: 20},
